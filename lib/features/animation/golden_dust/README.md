...
This folder is reserved for the golden_dust overlay animation renderer.

When implemented, it should:
- Expose a single `GoldenDustOverlay extends StatelessWidget` (or
